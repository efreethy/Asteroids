(function () {
  ...
  Game.prototype.addAsteroids = function () {
     for (var i=0; i < this.NUM_ASTEROIDS; i++) {
       var obj = { pos: this.randomPosition() , vel: Asteroids.Util.randomVec(Math.random() * (5))  };
       this.asteroids.push(new Asteroids.Asteroid(obj, this));
     }
     this.asteroidAccumInterval = setInterval(function () {
        this.asteroids.push(new Asteroids.Asteroid(
          new Asteroids.Asteroid({ pos: this.randomPosition() , vel: Asteroids.Util.randomVec(1)  }, this), this));
     }.bind(this), 1000);
  };
